...
expName = 'adaptive staircase-Vidhi-6-9-24'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vidna\\OneDrive\\Documents\\6-9-24 adaptive staircase\\adaptive staircase-Vidhi-6-9-24_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        # Run 'Begin Routine' code from var_50_50
        if random()>0.5: 
            direction= -level
            corr_resp= 'left'
        else: 
        ...
        # Run 'End Routine' code from var_50_50
